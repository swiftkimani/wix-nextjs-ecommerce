...
const Slider = ({ initialSlides }: { initialSlides?: SlideData[] }) => {
  ...
  if (slides.length === 0) {
    return <div className="h-[calc(100vh-80px)] bg-gray-50 flex items-center justify-center text-gray-400">Loading slides...</div>;
  }
